...
console.log('task 1d', multiply(10, 593));
...
Puppies less than 1 year
   2 - 4 months 10% of their body if(ageweight
...
console.log('task 6', annoyingSong(56));
